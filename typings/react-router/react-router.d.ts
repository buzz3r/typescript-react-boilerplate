...
declare module ReactRouter {
    ...
    interface Link extends Navigation, State {
    ...
    interface RouteHandler extends RouteHandlerMixin {
        __react_router_route_handler__: any; // dummy
    }
    interface RouteHandlerClass {
        __react_router_route_handler__: any; // dummy
    }
