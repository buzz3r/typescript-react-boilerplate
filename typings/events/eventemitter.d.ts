...
declare class EventEmitter {
     ...
     * @param listener
     */
    onAny(listener: Function): EventEmitter;

    /**
     * Removes the listener that will be fired when any event is emitted.
     * @param listener
     */
    offAny(listener?: Function): EventEmitter;
     ...
     * @param listener
     */
    many(event: string, timesToListen: number, listener: Function): EventEmitter;
     ...
     * @param events
     */
    removeAllListeners(events: string[]): EventEmitter;
